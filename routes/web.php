...
Route::patch('/home/update/image/{user}',  [App\Http\Controllers\ProfileController::class, 'update_image']);
...
Route::get('/home/Online/{id}', [App\Http\Controllers\UserOnlineController::class, 'online']);
Route::get('/home/Offline/{id}', [App\Http\Controllers\UserOnlineController::class, 'offline']);
